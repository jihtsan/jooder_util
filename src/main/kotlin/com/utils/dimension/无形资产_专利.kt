...
object 无形资产_专利 {
    ...
    fun main(args: Array<String>) {
        val crawlerDocument = "D:\\数据清洗文档\\无形资产-爬虫字典.xlsx"
        val document = "D:\\数据清洗文档\\无形资产-DWD字典.xlsx"
...
//        Mongo爬虫数据整理.输出结果(dbName, collectionName, 10000, keyDataPath, crawlerDocument)
        val projectName = "intangible-asset-patent"
        val projectNameCN = "无形资产_专利-清洗"
        val dwd_pre_table_name = "dwd_pre_intangible_assets_patent_c03"
        val dwd_pre_file_name = 文件名生成(dwd_pre_table_name)
        val dwd_table_name = "dwd_intangible_assets_patent_c03"
        val dwd_file_name = 文件名生成(dwd_table_name)
        val source_table = "ods.wxzc_patent_data"
